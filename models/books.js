...
let seedOfBook = () => {
  let newBook = [
    ...
    new books({
      ...
      author: "WG Sebald",
      description:
        "Sebald died in a car crash in 2001, but his genre-defying mix of fact and fiction, keen sense of the moral weight of history and interleaving of inner and outer journeys have had a huge influence on the contemporary literary landscape.",
      status: "intresting",
      email: process.env.email_ONE,
    }),
  ];
